...
rule.ix["Pair8"]["10"]="P" #縺薙ｌ縺ｯ繧ｹ繝励Μ繝・ヨ縺ｮ縺後ｈ縺輔◎縺・rule.ix["Pair8"]["1"]="P"  ##縺薙ｌ縺ｯ繧ｹ繝励Μ繝・ヨ縺ｮ縺後ｈ縺輔◎縺・rule.ix["Hard11"]["10"]="Dh" #or "Dh" 縺ｩ縺｣縺｡縺ｧ繧ゅ＞縺・▲縺ｽ縺・rule.ix["PairA"]["1"] = "P" #must sPrit !!!
...
def draw(deck1):
    ...
    drawcard_number = np.random.randint(len(deck1)) #  0縲徑en(deck)-1 縺ｮ謨ｴ謨ｰ繧・蛟狗函謌・    drawcard = deck[drawcard_number]
